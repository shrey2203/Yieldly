...
const Reports = () => {
    ...
    const [reportOptions] = useState([
        ...
        { id: 'dividends', reportName: "Dividends BreakDown", description: "Dividends BreakDown Recieved" },
        { id: 'dividendsTotal', reportName: "Total Dividends", description: "Total Dividends Recieved" }
    ]);
