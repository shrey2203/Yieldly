...
class EquityMarketData(db.Model):
    ...
    open = db.Column(db.BigInteger, unique=False, nullable=False)
    close = db.Column(db.BigInteger, unique=False, nullable=False)
    low = db.Column(db.BigInteger, unique=False, nullable=False)
    high = db.Column(db.BigInteger, unique=False, nullable=False)
